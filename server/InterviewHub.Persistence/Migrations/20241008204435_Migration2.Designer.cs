...
namespace InterviewHub.Persistence.Migrations
{
    ...
    [Migration("20241008204435_Migration2")]
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 8, 23, 44, 34, 5, DateTimeKind.Local).AddTicks(2220),
                            Email = "test@test.com",
                            IsDeleted = false,
                            PasswordHash = "10000:NlWQcjHD7EmsbLgZhzHTNg==:0wwaII+tF7cVif+HbDv+Z6TyDYQ7G8zRFZxp11xNiq0=",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2024, 10, 8, 23, 44, 34, 5, DateTimeKind.Local).AddTicks(2250)
                        });
                });
