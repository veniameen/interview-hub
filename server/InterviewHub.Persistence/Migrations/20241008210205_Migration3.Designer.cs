...
namespace InterviewHub.Persistence.Migrations
{
    ...
    [Migration("20241008210205_Migration3")]
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 9, 0, 2, 3, 613, DateTimeKind.Local).AddTicks(1070),
                            Email = "test@test.com",
                            IsDeleted = false,
                            PasswordHash = "10000:NlWQcjHD7EmsbLgZhzHTNg==:0wwaII+tF7cVif+HbDv+Z6TyDYQ7G8zRFZxp11xNiq0=",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2024, 10, 9, 0, 2, 3, 613, DateTimeKind.Local).AddTicks(1100)
                        });
                });
