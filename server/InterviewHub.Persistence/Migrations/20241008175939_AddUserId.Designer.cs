...
namespace InterviewHub.Persistence.Migrations
{
    ...
    [Migration("20241008175939_AddUserId")]
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 8, 20, 59, 39, 84, DateTimeKind.Local).AddTicks(3257),
                            Email = "test@test.com",
                            IsDeleted = false,
                            PasswordHash = "10000:NlWQcjHD7EmsbLgZhzHTNg==:0wwaII+tF7cVif+HbDv+Z6TyDYQ7G8zRFZxp11xNiq0=",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2024, 10, 8, 20, 59, 39, 84, DateTimeKind.Local).AddTicks(3273)
                        });
                });
