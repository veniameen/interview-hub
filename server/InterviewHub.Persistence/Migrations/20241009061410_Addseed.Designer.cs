...
namespace InterviewHub.Persistence.Migrations
{
    ...
    [Migration("20241009061410_Addseed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.Candidate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Description = "Кандидат на вакансию пайтон девелопер",
                            Email = "test@test.com",
                            IsDeleted = false,
                            Name = "Test Testov",
                            ResumeUrl = "http://",
                        ...
                        {
                            Id = 3,
                            Description = "Кандидат на вакансию C# jun",
                            Email = "kirill@test.com",
                            IsDeleted = false,
                            Name = "Frolov kirill",
                            ResumeUrl = "http://proger111",
                            Status = "Готовится"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            Name = "Test Karlov",
                            ResumeUrl = "http://teeee",
                            Status = "Отдыхает"
                        });
                });

            modelBuilder.Entity("InterviewHub.Domain.Entities.CodeChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.TaskEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.TaskType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 9, 9, 14, 10, 36, DateTimeKind.Local).AddTicks(5283),
                            Email = "test@test.com",
                            IsDeleted = false,
                            PasswordHash = "10000:NlWQcjHD7EmsbLgZhzHTNg==:0wwaII+tF7cVif+HbDv+Z6TyDYQ7G8zRFZxp11xNiq0=",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2024, 10, 9, 9, 14, 10, 36, DateTimeKind.Local).AddTicks(5296)
                        });
                });

            modelBuilder.Entity("InterviewHub.Domain.Entities.Candidate", b =>
                {
                    b.HasOne("InterviewHub.Domain.Entities.User", "User")
                        .WithMany("Candidates")
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.Interview", b =>
                {
                    ...
                    b.HasOne("InterviewHub.Domain.Entities.Room", "Room")
                        .WithOne("Interview")
                        .HasForeignKey("InterviewHub.Domain.Entities.Interview", "RoomId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    b.HasOne("InterviewHub.Domain.Entities.TaskType", "Type")
                        .WithMany("Tasks")
