...
namespace InterviewHub.Persistence.Migrations
{
    ...
    [Migration("20241008231340_FixName")]
            ...
            modelBuilder.Entity("InterviewHub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 9, 2, 13, 40, 386, DateTimeKind.Local).AddTicks(7444),
                            Email = "test@test.com",
                            IsDeleted = false,
                            PasswordHash = "10000:NlWQcjHD7EmsbLgZhzHTNg==:0wwaII+tF7cVif+HbDv+Z6TyDYQ7G8zRFZxp11xNiq0=",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2024, 10, 9, 2, 13, 40, 386, DateTimeKind.Local).AddTicks(7458)
                        });
                });
